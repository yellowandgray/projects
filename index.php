            ...
            <aside id="colorlib-hero">
                <div class="flexslider">
                    <ul class="slides">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
                                        <div class="slider-text-inner text-center">
                                            <h1>Karaikal's First Premium School</h1>
                        ...
                        <li style="background-image: url(images/banner-04.jpg);">
                            <div class="overlay"></div>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
                        ...
                        <li style="background-image: url(images/banner-05.jpg);">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
                                        <div class="slider-text-inner text-center">
                                            <h1>Disciplined Learning Structure</h1>
                                            <p><a href="#" class="btn btn-primary btn-lg btn-learn">Register Now</a></p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <li style="background-image: url(images/banner-09.jpg);">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
                                        <div class="slider-text-inner text-center">
                                            <h1>Smart Digitized Classrooms</h1>
                                            <p><a href="#" class="btn btn-primary btn-lg btn-learn">Register Now</a></p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <li style="background-image: url(images/banner-11.jpg);">
                            <div class="overlay"></div>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
                        ...
                        <li style="background-image: url(images/banner-07.jpg);">
                            <div class="overlay"></div>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <img src="images/istockphoto-679609770-2048x2048-Graduate.jpg" class="img-responsive img-border" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-3 text-center animate-box">
                                <div class="services">
                                    <img src="images/discipline-childrens.jpg" class="img-responsive" alt="" />
                            ...
                            <div class="col-md-3 text-center animate-box">
                                <div class="services">
                                    <div class="text-center"><img src="images/well-trained-staff.jpg" class="img-responsive" alt="" /></div>
...
<!--                                            <span class="colorlib-counter js-counter" data-from="0" data-to="1539" data-speed="5000" data-refresh-interval="50"></span>-->
                                        <span class="colorlib-counter-label">5 Acres Campus</span><br/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6 animate-box">
...
<!--                                            <span class="colorlib-counter js-counter" data-from="0" data-to="3653" data-speed="5000" data-refresh-interval="50"></span>-->
                                        <span class="colorlib-counter-label">A/C School & A/C Buses</span><br/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6 animate-box">
...
<!--                                            <span class="colorlib-counter js-counter" data-from="0" data-to="2300" data-speed="5000" data-refresh-interval="50"></span>-->
                                        <span class="colorlib-counter-label">Smart Interactive Classrooms</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6 animate-box">
                                <div class="counter-entry">
                                    ...
                                    <span class="colorlib-counter-label">Fully Secured With CCTV Cameras</span>
                                    <!--                                        </div>-->
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 colorlib-heading animate-box">
                            ...
                            <div class="row">
                                <div class="col-md-4 text-center border-right">
                                    ...
                                    <p class="margin-top-10 text-justify">Early Childhood education is the child’s first step towards social engagement. This prepares toddlers through Experiential learning activities, making real life connections. Our program is based largely on the developmentally appropriate practice thereby delivering the right curriculum at the right age</p> 
                                </div>
                                <div class="col-md-4 text-center border-right">
                                    <span class="dot"><p>LKG & UKG</p></span>
                                    <p class="margin-top-10 text-justify">The Kindergarten programs provided the child with Academic and overall readiness to step into the world of Primary education, from Early years.</p><br/><br/><br/><br/>
                                </div>
                                <div class="col-md-4 text-center">
                                    <span class="dot"><p>CLASSES <br/>I to V</p></span>
                                    <p class="margin-top-10 text-justify">Primary class program, to be affiliated to the CBSE method of education, is available from the Academic year 2019. Our friendly & welcoming classrooms offer children the space to learn the right way.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="colorlib-testimony" class="testimony-img" style="padding: 30px 0px;">
                <!--                    <div class="overlay"></div>-->
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 text-center">
                            <div class="row animate-box">
                                ...
                                <div class="col-md-6 hover-btn">
                                    ...
                                    <a href="#" class="btn btn-color color-white text-center">Read More</a>
                                    <!--                                        <h5 class="bold color-white text-left">Founder and CHAIRMAN:  MARAICAYAR TRUST (1992)</h5>-->
                                    <!--                                        <p class="text-justify color-white">It is philanthropy that the Trust is dealing with. The Trust has the  objective of developing projects for the benefit of society in the fields of Education and Health.<br/>With traditional type of assistance for education which is ongoing, the Trust stood in the front in helping victims of the floods and cyclones in Tamilnadu in the recent years.<br/>In the wake of the overwhelming loss suffered by the victims of cyclone GAJA,  several truckloads of relief materials were quickly despatched to the affected areas, notwithstanding the fact that the promoter’s family too had suffered  extensive loss of assets.<br/>He desires to establish International Schools of a high standard to bring the best in our children and contribute immensely in the field of Education  and Nation-building activities.<br/>Associated with various  educational and social activities aimed at human welfare, he proud to be a senior Rotarian, and a Paul Harris Fellow  of the  Rotary Club of Thanjavur South.</p>-->
                                </div>
                                <div class="col-md-1"></div>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 text-center colorlib-heading animate-box">
                        <img src="images/happy-parents.jpg" class="img-responsive" alt=""/>
<!--                            <p>Subscribe our newsletter and get latest update</p>-->
                    </div>
                    <div class="col-md-4 text-center colorlib-heading animate-box">
                        <h3 class="text-justify">Dear Parents, <br/>Thank you for visiting our site. We look forward to meeting with you in person to discuss the Bright Future and Quality Education our Prestigious Institution can offer<br/>Kindly Fill Out the Enquiry Form for further Details, <br/> With Best regards, <br/> ENPEE Management</h3>
                        <p></p>
                    </div>
                    ...
                    <div class="col-md-4 animate-box">
                        <form id="contact" action="" method="post">
                            ...
                            <fieldset>
                                <input placeholder="Number Of Children" type="url" tabindex="4" required>
                            </fieldset>
